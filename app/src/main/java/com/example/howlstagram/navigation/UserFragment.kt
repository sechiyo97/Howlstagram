...
import kotlinx.android.synthetic.main.activity_main.view.toolbar_username
...
class UserFragment : Fragment(){
        ...
        firestore?.collection("users")?.document(uid!!)?.addSnapshotListener { documentSnapshot, firebaseFirestoreException ->
            ...
            if(followDTO?.followerCount != null){
                ...
                if (followDTO?.followers?.containsKey(currentUserUid!!)){
                    ...
                    fragmentView?.account_btn_follow_signout?.background?.setColorFilter(ContextCompat.getColor(activity!!, R.color.colorAccent), PorterDuff.Mode.MULTIPLY)
                } else{
                    if(uid != currentUserUid) {
                        fragmentView?.account_btn_follow_signout?.text = getString(R.string.follow)
    ...
    inner class UserFragmentRecyclerViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        init {
            firestore?.collection("images")?.whereEqualTo("uid", uid)?.addSnapshotListener{ querySnapshot, firebseFirestore ->
